...
***Ask not what IntelliHost can do for you - ask what you can do for IntelliHost***
...
2. Include additional information such as:
    ...
    * IntelliHost Debug-Info containing:
...
1. Respect existing IntelliHost coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
