...
/**
 * @brief Default IP address for the IntelliHost server.
 */
#define IntelliHostIP _T("127.0.0.1")

 /**
  * @brief Default port for the IntelliHost service.
  */
#define IntelliHostPort 8081

  /**
   * @brief XML section name for IntelliHost settings.
   */
#define IntelliHostSection _T("IntelliHost")
